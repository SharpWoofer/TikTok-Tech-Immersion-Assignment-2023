...
func (c *Client) StartClient(ctx context.Context, address, password string) error {
...
func (c *Client) SaveMessage(ctx context.Context, roomID string, message *Message) error {
...
func (c *Client) GetMessagesByRoomID(ctx context.Context, roomID string, start, end int64, reverse bool) ([]*Message, error) {
	var (
		rawMessages []string
		messages    []*Message
		err         error
